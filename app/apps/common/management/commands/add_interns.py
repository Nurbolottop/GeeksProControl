...
ROSTER = [
    ...
    ('олимпийская', 'UX/UI', TeamRole.UXUI, [
        'Шаршеналы кызы Айгерим',
        'Алапаев Умар',
        'Тынчтыкбекова Айзель',
        'Решетун Данил',
        'Рысбек кызы Раяна',
        'Айдаров Сабыр',
        'Джеенбекова Малика',
    ...
    ('умай', 'Testing/QA', TeamRole.QA, [
        'Эсенова Нурайым Сапарбековна',
    ]),
    ('умай', 'Backend', TeamRole.BACKEND, [
        'Артур Мамасаков',
        'Азамжанов Мухаммадали',
    ]),
