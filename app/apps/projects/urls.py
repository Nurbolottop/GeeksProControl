...
urlpatterns = [
    ...
    path('<int:pk>/access/request/', views.access_request_create,
         name='access_request_create'),
    path('access-request/<int:pk>/provide/', views.access_request_provide,
         name='access_request_provide'),
    path('access-request/<int:pk>/decline/', views.access_request_decline,
         name='access_request_decline'),
    path('access-request/<int:pk>/delete/', views.access_request_delete,
         name='access_request_delete'),
